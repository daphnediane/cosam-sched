...
/// `"Modified: Jun 15 4:00 PM | Generated: Jun 15 4:05 PM"`.
///
...
/// Format an RFC 3339 timestamp as `"Jun 15 4:00 PM"`, or `None` if unparseable.
...
mod tests {
    ...
    fn test_footer_timestamps_dedups_generated() {
        ...
        assert_eq!(same, "Modified: Jun 15 4:00 PM");

        // Differing → both shown.
        let both = footer_timestamps("2026-06-15T16:00:00Z", "2026-06-15T16:05:00Z");
        assert_eq!(both, "Modified: Jun 15 4:00 PM | Generated: Jun 15 4:05 PM");
    }
