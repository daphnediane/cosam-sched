...
/// ```
///
/// - `PREFIX` — two or more uppercase letters, **normalised to 2 characters**
...
/// # Examples
///
/// | Input          | prefix | prefix_num | part_num | session_num | suffix   |
/// |----------------|--------|------------|----------|-------------|----------|
/// | `"GP002"`      | `"GP"` | 2          | –        | –           | –        |
/// | `"GW097P1"`    | `"GW"` | 97         | 1        | –           | –        |
/// | `"GW097P2S3A"` | `"GW"` | 97         | 2        | 3           | `"A"`    |
/// | `"GW093P1AS4B"`| `"GW"` | 93         | 1        | 4           | `"AB"`   |
/// | `"SPLIT01"`    | `"SP"` | 1          | –        | –           | –        |
#[derive(Debug, Clone, PartialEq, Eq, Hash, Serialize, Deserialize)]
pub struct PanelUniqId {
    /// Normalised 2-letter uppercase prefix (e.g. `"GP"`, `"SP"`, `"BR"`).
    pub prefix: String,
...
mod tests {
    ...
    #[test]
    fn parse_with_part_and_session_and_suffix() {
    ...
    #[test]
    fn parse_session_before_part() {
        let pid = PanelUniqId::parse("GW093S4AP1B").unwrap();
        assert_eq!(pid.part_num, Some(1));
        assert_eq!(pid.session_num, Some(4));
        assert_eq!(pid.suffix, Some("AB".to_string()));
    }
