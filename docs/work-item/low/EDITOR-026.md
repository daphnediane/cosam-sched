...
- Editor can open XLSX files from OneDrive
- Changes can be saved back to OneDrive
- Authentication works on macOS and Windows
- File conflict detection for shared files
