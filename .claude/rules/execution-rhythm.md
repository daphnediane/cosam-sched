...
6. Per `.claude/rules/track_work_item.md`, run `scripts/work-item-update.pl` to update `docs/WORK_ITEMS.md` and reorganize work-item files
7. Follow `.claude/rules/prepare-comment.md`, create `next_commit.tmp`, if in doubt ask user for AI model.
