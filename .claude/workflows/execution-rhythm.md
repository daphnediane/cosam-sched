...
Execute a single work item or plan phase. See `.claude/rules/execution-rhythm.md` for principles and guidelines.
...
**New work:** Follow `.claude/workflows/commit-changes.md` — creates new commit from `./next-commit.txt`

**Fixes to same work item:** Follow `.claude/workflows/amend-changes.md` — amends previous commit using `./next-amend.txt`
...
See `.claude/rules/execution-rhythm.md` for detailed flexibility guidelines.
